...
import com.mmsk.book_social_network.common.PageResponse;
import com.mmsk.book_social_network.exception.OperationNotPermittedException;
import com.mmsk.book_social_network.file.FileStorageService;
import com.mmsk.book_social_network.history.BookTransactionHistory;
import com.mmsk.book_social_network.history.BookTransactionHistoryRepository;
...
import static com.mmsk.book_social_network.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer save(BookRequest request, Authentication authentication) {
        ...
        book.setCreatedBy(user.getId().intValue());
